...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Vault":
		...
		case "WtihUserpassAuth":
			...
			return (*Vault).WtihUserpassAuth(&parent, ctx, username, password, path), nil
		case "GetSecretJSON":
			var parent Vault
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			var operationType Optional[string]
				...
				dag.TypeDef().WithObject("Vault").
					...
					WithFunction(
						dag.Function("GetSecretJSON",
							...
							WithArg("operationType", dag.TypeDef().WithKind(StringKind).WithOptional(true))).
					WithFunction(
